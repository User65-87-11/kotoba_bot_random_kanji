...
# Run the script
subprocess.run(['python', script_rep, ".\\data\\reps.txt", ".\\data\\decks\\all.csv", ".\\kotoba_csv\\out_reps.txt"])
...
subprocess.run(['python', script_csv, ".\\kotoba_csv\\out_reps.txt", ".\\kotoba_csv\\out_reps.csv"])
